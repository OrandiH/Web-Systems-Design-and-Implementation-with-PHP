...
$Val = 0;
$errFlag = 0;
//Check the user input from form
...
function process_customer_query($value1,$value2,$value3,$value4,$value5,$value6,$value7,$errFlag)
{
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	if(isset($_POST['btnsubmit']))
	{
		...
		,$cleanUserEmail,$cleanUserAge,$cleanUserAddress,$cleanUserComplaint,$errFlag);
...
<head>
	...
	<title>WSDI-IndividualAssessment_OrandiHarris</title>
</head>
<body>
